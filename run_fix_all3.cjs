...
c = c.replace('periodo: 1 | 2 | 3; // Seguimiento 1, 2, 3', 'periodo: 1 | 2 | 3 | 4; // Seguimiento 1, 2, 3, Anexo 6');

// Add types to CompromisoFuncional
...
// Add types to CompromisoComportamental
...
// Add types to Evaluacion1278
c = c.replace('portfolioPdfName?: string;', `portfolioPdfName?: string;
...
if (!c.includes('generarAnexo6Word')) {
  c = c.replace("import { generarActaGeneralWord } from '../utils/actaGeneralGenerator';", "import { generarActaGeneralWord } from '../utils/actaGeneralGenerator';\nimport { generarAnexo6Word } from '../utils/exportAnexo6';");
}
...
console.log('Successfully completed full Anexo 6 & type update.');
