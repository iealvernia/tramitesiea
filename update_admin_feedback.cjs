...
const targetStr = `              {/* Feedback Inputs */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-50/50 border border-blue-100 p-4 rounded-xl space-y-3">
                  <div className="space-y-1">
                    <h4 className="font-extrabold text-blue-800 text-xs uppercase tracking-wider">Retroalimentacin Anexo 2</h4>
                    <p className="text-[10px] text-blue-600/70">Comentarios especficos para evidencias de Anexo 2.</p>
                  </div>
                  <textarea
                ...
                <div className="bg-purple-50/50 border border-purple-100 p-4 rounded-xl space-y-3">
                  <div className="space-y-1">
                    <h4 className="font-extrabold text-purple-800 text-xs uppercase tracking-wider">Retroalimentacin Anexo 5</h4>
                    <p className="text-[10px] text-purple-600/70">Comentarios especficos para evidencias de Anexo 5.</p>
                  </div>
                  <textarea
              ...
              <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl space-y-4">
                <div className="flex items-center justify-end gap-3 pt-2">
                  <button
                    ...
                    title="Eliminar este envo falso/borrador"
                  >
