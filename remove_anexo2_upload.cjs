...
const targetBlock = `                          <div className="md:col-span-8">
...
const replaceBlock = `                          <div className="md:col-span-12">
                            <label className="block text-[10px] font-extrabold text-slate-400 uppercase tracking-wider mb-1">Nombre / Descripción de la Evidencia</label>
                            <input
                              type="text"
                              value={row.nombre || ''}
...
if (c.includes(targetBlock)) {
    ...
    console.log('Successfully removed Anexo 2 file upload block.');
} else {
