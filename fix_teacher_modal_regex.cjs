...
c = c.replace(/<div className="p-5">\s*<p className=\{`text-sm font-semibold whitespace-pre-wrap leading-relaxed \$\{textClass\}`\}>\s*\{ev\.observacionesAdmin\}\s*<\/p>\s*<\/div>/g, 
...
console.log('Fixed Teacher modal rendering using Regex');
