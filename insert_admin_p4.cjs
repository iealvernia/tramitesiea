                      ...
                      <table className="w-full text-left text-xs border-collapse">
                        <thead>
                          <tr className="bg-slate-100 text-slate-600 uppercase tracking-wider">
                            ...
                            <th className="p-3 font-bold border-b border-slate-200 w-32">1ra Val.</th><th className="p-3 font-bold border-b border-slate-200 w-32">2da Val.</th><th className="p-3 font-bold border-b border-slate-200 w-32 bg-blue-50/50">FINAL</th>
                          </tr>
                        </thead>
                              ...
                              <td className="p-3">
                                ...
                                <td className="p-3">
                                  <input
                                    type="number"
                                    min="1" max="100"
                                    disabled={selectedEvalForInspection.estado === 'Enviado' || selectedEvalForInspection.estado === 'Aprobado'}
                                    value={cf.puntaje || 0}
                                    onChange={(e) => {
...
c = c.replace(s1, insertBefore);

fs.writeFileSync('src/components/EvaluacionDocentePanel.tsx', c);
console.log('Admin Period 4 UI inserted');
